...
def get_models(img_height, img_width, download_weights=True):
    ...
    text_encoder_weights_fpath = tf.keras.utils.get_file(fname='text_encoder',
    ...
    diffusion_model_weights_fpath = tf.keras.utils.get_file(fname='diffusion_model',
    ...
    decoder_weights_fpath = tf.keras.utils.get_file(fname='decoder',
